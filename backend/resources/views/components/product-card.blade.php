...
<article class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden flex flex-col">
    ...
    <div class="p-4 flex-1 flex flex-col gap-2">
        ...
        <div class="mt-auto">
            ...
            <form method="POST" action="/carrinho" class="mt-3 space-y-2">
                @csrf
                ...
                <button class="w-full bg-cyan-600 text-white text-sm font-semibold py-2 rounded-full hover:bg-cyan-700 transition flex items-center justify-center gap-2">
