<header class="bg-white shadow-sm sticky top-0 z-30">
    <div class="mx-auto max-w-6xl px-4 py-3 flex items-center justify-between gap-3">
        <a href="/" class="flex items-center gap-2 text-cyan-600 font-bold text-lg">
        ...
        <nav class="flex items-center gap-3 text-slate-700">
            ...
            <a href="/carrinho" class="relative flex flex-col items-center text-xs">
                <i class="fa-solid fa-basket-shopping fa-shopping-basket text-lg" aria-hidden="true"></i>
            ...
            @auth
                <a href="/conta" class="hidden sm:flex items-center gap-2 text-sm font-semibold bg-cyan-600 text-white px-4 py-2 rounded-full hover:bg-cyan-700 transition">
                    <i class="fa-solid fa-user"></i>
                    {{ \Illuminate\Support\Str::limit(auth()->user()->name, 10) }}
                </a>
            @else
                <a href="/login" class="hidden sm:flex items-center gap-2 text-sm font-semibold bg-cyan-600 text-white px-4 py-2 rounded-full hover:bg-cyan-700 transition">
                    <i class="fa-solid fa-user"></i>
                    Entrar
                </a>
            @endauth
